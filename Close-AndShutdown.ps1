# Close applications and shutdown PC
param (
    [switch]$Force = $false
)
...
function Show-ConfirmationPrompt {
    ...
    $message = "WARNING: This script will attempt to close all running programs and shutdown the PC.`nPlease save any important work before continuing.`nDo you want to proceed?"
    
    $yes = New-Object System.Management.Automation.Host.ChoiceDescription "&Yes", "Close all applications and shutdown"
