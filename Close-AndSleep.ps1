# Close applications and put PC to sleep
param (
    [switch]$Force = $false
)
...
function Show-ConfirmationPrompt {
    ...
    $message = "WARNING: This script will attempt to close all running programs.`nPlease save any important work before continuing.`nDo you want to proceed?"
    
    $yes = New-Object System.Management.Automation.Host.ChoiceDescription "&Yes", "Close all applications and sleep"
...
Write-Host "Putting PC to sleep..."
